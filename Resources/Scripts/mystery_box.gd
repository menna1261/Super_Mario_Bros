...
#Bonus references
const COIN = preload("res://Resources/scenes/coin.tscn")
const SHROOM_SCENE = preload("res://Resources/scenes/shroom.tscn")
const shootingFlower = preload("res://Resources/scenes/shooting_flower.tscn")
...
func spawn_flower():
	var flower = shootingFlower.instantiate()
